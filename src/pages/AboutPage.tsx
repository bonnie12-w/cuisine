          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground">
                About <span className="gold-gradient-text italic">nana swahili restaurant</span>
              </h1>
            </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              {[
                ...
                { icon: Mail, text: "hello@nanaswahilirestaurant.co.ke" },
                { icon: Instagram, text: "@nana_swahili_restaurant" },
